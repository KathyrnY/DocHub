...
function AddCalendarDays(Year, Month, Object) {
  ...
  var HeaderRow =
    "<table><tr><td onclick='AddCalendarDays(window.Year, window.Month - 1);'>❮</td><td onclick='AddCalendarMonths(window.Year);'>" +
    window.Months[window.Month] +
    ' ' +
    window.Year.toString() +
    "</td><td onclick='AddCalendarDays(window.Year, window.Month + 1);' >❯</td></tr></table>";

  var MainContent =
    '<table><tr><td>Su</td><td>Mo</td><td>Tu</td><td>We</td><td>Th</td><td>Fr</td><td>Sa</td></tr>';
  ...
  window.DatePickerTable.innerHTML =
    '<tr><td>' + HeaderRow + '</td></tr><tr><td>' + MainContent + '</td></tr>';
}
...
function AddCalendarMonths(Year) {
  ...
  var HeaderRow =
    "<table><tr><td onclick='AddCalendarMonths(window.Year - 1);'><</td><td>" +
    window.Year.toString() +
    "</td><td onclick='AddCalendarMonths(window.Year + 1);' >></td></tr></table>";
  ...
  for (r = 0; r < 3; r++) {
    ...
    for (c = 0; c < 4; c++) {
      var MonthNo = r * 4 + c;
      MainContent +=
        "<td onclick='AddCalendarDays(window.Year, " + MonthNo + ", null);'>";
